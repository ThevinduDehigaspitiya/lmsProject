                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="breadcrumb-main">
                                <a href="{{ route('student') }}" class="active">
                                        ...
                                        <div class="label-detailed__single"><span
                                            ...
                                            <strong class="label-detailed__total">$8,550</strong> <span
                                                class="label-detailed__status color-success"><img class="svg"
                                                    src="{{ asset('assets/img/svg/arrow-success-up.svg') }}"
                                        ...
                                        <div class="label-detailed__single"><span
                                            ...
                                            <strong class="label-detailed__total">$5,550</strong> <span
                                                class="label-detailed__status color-danger"><img class="svg"
                                                    src="{{ asset('assets/img/svg/arrow-danger-down.svg') }}"
                                                    alt=""> <strong>15%</strong></span>
                                        </div>
                                    </div>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <img class="radius-xs img-fluid order-bg-opacity-primary"
                                                                            src="{{ asset('assets/img/premium-clock.png') }}"
                                                                            alt="img">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div
                                                                        class="selling-product-img d-flex align-items-center">
                                                                        <img class="radius-xs img-fluid order-bg-opacity-primary"
                                                                            src="{{ asset('assets/img/t-shirt.png') }}"
                                                                            alt="img">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div
                                                                        class="selling-product-img d-flex align-items-center">
                                                                        <img class="radius-xs img-fluid order-bg-opacity-primary"
                                                                            src="{{ asset('assets/img/cup-glass.png') }}"
                                                                            alt="img">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div
                                                                        class="selling-product-img d-flex align-items-center">
                                                                        <img class="radius-xs img-fluid order-bg-opacity-primary"
                                                                            src="{{ asset('assets/img/women-bag.png') }}"
                                                                            alt="img">
                                                                        <span>Women Bag</span>
                                                                    </div>
                                                                </td>
