                                    ...
                                    <form action="#">
                                        <div class="row">
                                                    ...
                                                    <div class="dm-tag-wrap">
                                                        ...
                                                        <div class="dm-upload">
                                                            <div class="dm-upload-avatar">
                                                                <img class="avatrSrc"
                                                                    src="{{ asset('assets/img/author-nav.jpg') }}"
                                                                    alt="Avatar Upload">
                                                            </div>
                                                            <div class="avatar-up">
                                            ...
                                            <div class="col-8">
                                                <div class="card  card-default card-md mb-4">
                                                    ...
                                                    <div class="card-body py-md-30">
                                                        ...
                                                        <p class="color-light mt-0 fs-14">Click image preview to RESET
                                                            your image </p>
                                                        <p class="color-light mt-0 fs-14">Allowed JPG, JPEG, MAx size of
                                                            1MB </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layout-button mt-25">
                                                ...
                                                <button type="button"
                                                    class="btn btn-primary btn-default btn-squared px-30">Next</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
